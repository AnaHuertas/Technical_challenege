...
for i in range(3):
    print("Option ",i+1)
    print(message[i][0],reciever.rstrip(),message[i][1],timestimation[j],message[i][2],sender)
    print('\n\n')
...
print(message[k][0],reciever,message[k][1],timestimation[j],message[k][2],sender,'\n')
