...
if jj=="1"or jj=="2"or jj=="3": #this loop select the time option according with the user selection.
    j=int(jj)-1
...
emailarray = [['Hello','Thank you for reaching out. We recieved your message and will do our best to get back to you','If you need help immediately, please call us, or see if our Help Center could be helpfull.\n\nHave a beautiful evening!\n\nRegards,'],
    ['Hi','Thanks so much for your email! This auto-reply is just to let you know...\n\nWe recieved your email and will get back to you with a human response','For general questions, check out our Help Center, it might help.\nIf you need help immediately, please give us a call.\n\nI look forward to chatting soon!\n\nCheers,'],
...
for i in range(len(emailarray)): #this loop shows to the user how the 3possible email would look like
    print(f'Option {i+1}')
    email=emailarray[i]
...
print(f'{email[0]} {reciever},\n\n{email[1]} {timeframe}.\n\n{email[2]}\n{sender}') #this shows in the screen the selected version of the email
print('\n')

pyperclip.copy(f'{email[0]} {reciever},\n\n{email[1]} {timeframe}.\n\n{email[2]}\n{sender}') #this copy the email on the computer clipboard soit can be pasted wherever

fin=input("The email has been copied on the clipboard") #stops the program until enter is press so the user can read the information